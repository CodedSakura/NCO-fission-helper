...
export default function PanelTest() {
  return <PanelDock id="Main" leftTop={[
    ...
    {data: <div>Data [400]</div>, name: "Panel [400]", defaultOpen: true},]}>BODY</PanelDock>;
}
